...
class Jira:
    ...
    def generateNotionReplacementDictionary(self, sprint_report_data):
        ...
        try:
            ...
            notion_dictionary['[original-committed-link]'] = f"{sprint_report_data['issue_metrics']['issue_keys']['committed']} Originally Committed Issues"
            if sprint_report_data['issue_metrics']['issue_keys']['committed']:
            ...
            notion_dictionary['[completed-issues-link]'] = f"{sprint_report_data['issue_metrics']['issue_keys']['completed']} Completed Issues"
            if sprint_report_data['issue_metrics']['issue_keys']['completed']:
            ...
            notion_dictionary['[items-not-completed-link]'] = f"{sprint_report_data['issue_metrics']['issue_keys']['completed']} Incomplete Issues"
            if sprint_report_data['issue_metrics']['issue_keys']['incomplete']:
            ...
            notion_dictionary['[items-removed-link]'] = f"{sprint_report_data['issue_metrics']['issue_keys']['completed']} Removed Issues"
            if sprint_report_data['issue_metrics']['issue_keys']['removed']:
            ...
            notion_dictionary['[items-added-link]'] = f"{sprint_report_data['issue_metrics']['issue_keys']['completed']} Added Issues"
            if sprint_report_data['issue_metrics']['issue_keys']['added']:
